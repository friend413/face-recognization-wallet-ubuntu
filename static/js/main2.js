...
const validemails = ["ceo@anonid.io","a@a.com","varun.chintalapati@duke.edu","e.kim@duke.edu","aldo.oyadomari@duke.edu","nicolas.kudrna@duke.edu","ina.jain@duke.edu","linh.nguyen@duke.edu","Enkhhulan.enkhbold@duke.edu","ria.singh@duke.edu","fmaure@duke.edu","nikhil.kashyap@duke.edu","Jo166@duke.edu"];
...
// TODO
// add function to load names from the db into an array called usedemails
// const usedemails = ["ceo@anonid.io"];
//
//
//
...
// Check to make sure name is not in the DB
	if (!checkname())
